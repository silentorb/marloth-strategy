...
| [session/console-loop.md](session/console-loop.md) | Changing **console session** commands (Enter / `-` / `+` / `w` / `a` / `q`), modal screens, step resolution, open-ended play, or player-facing **post-tick I/O reports**. |
