...
| [gameplay/production-flows.md](gameplay/production-flows.md) | Designing or changing **production flows**, nodes, resources/signals, **actors**, **assignment**, payroll/treasury, circular configs, or the magic-agency seed. |
