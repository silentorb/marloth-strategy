...
| [ui/console-client.md](ui/console-client.md) | Changing **console Client** session loop, prompts (Enter / `-` / `+` / `q`), step resolution prefs, stock/I/O formatting, **SCENARIO_PRESET** / **SCENARIO_SEED**, or IDE play launch for the App. |
