...
| [gameplay/production-simulation.md](gameplay/production-simulation.md) | Changing **production graph** types, port signals, **AdvanceTick** / **AdvanceTickWithReport**, effort/assignment math, payroll/treasury, or magic-agency seed factories in Simulation. |
| [ui/console-client.md](ui/console-client.md) | Changing **console Client** session loop, prompts, stock/I/O formatting, or IDE play launch for the App. |
